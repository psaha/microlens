...
We considered two sources, as follows.
\begin{itemize}
\item The crescent source (as explained in \S\ref{subsec:crescent})
  with parameters
\begin{equation}
   (R_p, R_n/Rp, a/Rp, b/Rp) = (1.31, 0.4, 0, 0.3)
\label{eqn:cp}
\end{equation}
corresponding to $r_{1/2}=1$.
\item A Gaussian source (as explained in \S\ref{subsec:crescent}),
  also with $r_{1/2}=1$.
\end{itemize}
Unit length has 30 pixels on the magnification map and 30 points on a
light curve.

Each lightcurve has 251 points regularly spaced in time, with Gaussian
noise at the level of 4\% of the current brightness.

Mock data were generated by taking path-I lightcurves for 
...
This mimics the unavoidable systematic error of not knowing the
caustic exactly.
...
\begin{figure}
\centering
  \includegraphics[width=0.9\hsize]{figures/cc_forward.eps}
\caption{\label{fig:cc_forward} $\chi^2=243, P=0.32$.}
\end{figure}

\begin{figure}
\centering
  \includegraphics[width=0.9\hsize]{figures/cc_backward.eps}
\caption{\label{fig:cc_backward} $\chi^2=284, P=0.01$.}
\end{figure}

\begin{figure}
\centering
  \includegraphics[width=0.9\hsize]{figures/gc_forward.eps}
\caption{\label{fig:gc_forward} $\chi^2=344, P=3\times10^{-6}$.}
\end{figure}
...
correct model, and its parameters would be correctly recovered.
...
generous support during the Schrödinger visiting professorship in 2013.
