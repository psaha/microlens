...
instrumentation.  In the present paper, we consider a possible
indirect method, related to \cite{1999ApJ...524...49A} and
\cite{2013ApJ...769..131C}, through which gravitational microlensing
could probe the black hole shadow and its proximal quasar environment.
...
\caption{\label{fig:a_var} Lightcurves of crescent sources with $R_n$
  = 0.4 $R_p$.}
\end{figure}
