...
\caption{\label{fig:lightcurve_crescent} Geometry of crescent sources.}
\end{figure}
...
\caption{\label{fig:lightcurve_crescent} Lightcurves of backwards crescents with  a = 0.3 $R_p$.}
\end{figure}
