...
real parameters11(7),parameters12(7),parameters13(7),parameters21(7),&
	parameters22(7),parameters23(7),parameters31(7),parameters32(7),parameters33(7)
parameters(1) = 50.0
parameters(2) = 30.0
parameters(3) = 15.0
parameters(4) = -10.0
...
parameters11 = (/51.586,34.8926,19.565,-7.745,-1.6404,-49.9942,0.9123/)
parameters12 = (/50.9075,14.8337,17.599,4.6929,-1.9626,-49.9192,0.9389/)
parameters13 = (/99.8746,63.9408,25.9168,-8.2191,49.3638,-49.9391,0.6861/)

parameters21 = (/62.4322,30.,15.,-10.,43.699,-49.0282,0.9455/)
parameters22 = (/52.6674,30.,15.,-10.,5.6281,-49.2094,0.9412/)
parameters23 = (/73.7972,30.,15.,-10.,49.6405,-49.7145,0.8659/)

parameters31 = (/32.9892,30.,15.,-10.,-44.4476,-49.236,0.9546/)
parameters32 = (/34.0225,30.,15.,-10.,-49.9869,-49.2607,0.944/)
parameters33 = (/53.0767,30.,15.,-10.,12.7279,-49.384,0.9609/)

!	call lightcurveCrescent(parameters11,likelihood)
!	write(*,*) 'Hurray',parameters11, likelihood

!	call lightcurveDisk(parameters23,likelihood)
!	write(*,*) 'Hurray',parameters23, likelihood

	call lightcurveGauss(parameters33,likelihood)
	write(*,*) 'Hurray',parameters33, likelihood
...
!*
!*
	open (111,file='data_crescent_reverse_noise.txt')	!Cl data
...
!		write(11,*) i0,norm*value,data_crescent1(i+fit)
		end if
            endif
	 enddo
!	write(*,*) 'chi2',chi2
...
!		write(11,*) i0,norm*value,data_disk1(i+fit)
		end if
...
!
		...
		write(11,*) i0,norm*value,data_gauss1(i+fit)
		end if
!
!
!
